<?php
  ...
  $address = "";
  $note = "";
  $treatmentName ="Select Treatment";
  $total ="0";
  $recevid = "0";
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $recevid = $_POST["recevid"];
      ...
      do {
        ...
        $sql = "INSERT INTO `tbl_patient`( `P_Name`, `P_Gender`, `P_Age`, `P_Phone`, `P_Address`,  `P_Note`, `U_ID`, `PT_ID`) VALUES
        ('$name','$gender','$age','$phone','$address','$note', 1 , 2 );";
        $res = $con->query($sql);
            ...
            <ul>
              <?php
                ...
                foreach ($data as $value) {
                  echo '<li  ><a Class="list" href="?value=' . $value . '">' . $value . '</a></li>';
                }
              ?>
